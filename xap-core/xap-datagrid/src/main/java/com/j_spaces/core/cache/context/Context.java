...
public class Context {
    ...
    public boolean isMemoryOnlyEntry(){
        return TieredState.TIERED_HOT.equals(entryTieredState);
    }

    public boolean isDiskOnlyEntry(){
        return TieredState.TIERED_COLD.equals(entryTieredState);
    }
